    ...
    public class MainWindowViewModel : WindowViewModel, IMainWindowViewModel, INotifyPropertyChanged
    {
            ...
            :base(window, closeWindowCommand)
        {
           ...
           this.Pages.Add("AdminPage", new AdminPage(_context, this.Window));
            this.Pages.Add("SettingsPage", new SettingsPage(_context, this.Window));
            this.Pages.Add("BookingPage", new BookingPage(_context, this.Window));
            this.Pages.Add("RoomPage", new RoomPage(_context, this.Window));
            this.Pages.Add("CustomerPage", new CustomerPage(_context, this.Window));
            //current page
